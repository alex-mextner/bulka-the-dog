...
export const translations: Translations = {
  ru: {
    ...
    media: {
      ...
      story_alt: "Я на лавочке с двумя людьми и маленькой лохматой собакой",
      story_caption: "С чужими собаками без драм — даже с этим лохматым",
      ...
      strip: {
        ...
        home_caption: "Кошки по своим делам, я — по своим",
        vet_alt: "Я лежу на ковре в гостях, на заднем плане телевизор",
        vet_caption: "Команды я учу. Иногда даже выполняю",
        park_alt: "Я в парке с другой собакой и двумя людьми",
        park_caption: "В парке с друзьями",
        car_walk_alt: "Я с Леной у машины, уже тяну поводок в сторону дел",
        car_walk_caption: "Машины меня не пугают. Я деловая, иду по маршруту",
  ...
  rs: {
    ...
    media: {
      ...
      story_alt: "Ja na klupi sa dvoje ljudi i malim čupavim psom",
      story_caption: "Sa drugim psima bez drame — čak i sa ovim čupavkom",
      ...
      strip: {
        ...
        home_caption: "Mačke za svojim poslom, ja — za svojim",
        vet_alt: "Ležim na tepihu u gostima, u pozadini televizor",
        vet_caption: "Komande učim. Ponekad ih i izvršim",
        park_alt: "Ja u parku sa još jednim psom i dvoje ljudi",
        park_caption: "U parku sa drugarima",
        car_walk_alt: "Ja sa Lenom pored auta, već vučem povodac ka obavezama",
        car_walk_caption: "Auti me ne plaše. Poslovna sam, idem svojom rutom",
  ...
  en: {
    ...
    media: {
      ...
      story_alt: "Me on a bench with two people and a small fluffy dog",
      story_caption: "No drama with other dogs — not even this fluffy one",
      ...
      strip: {
        ...
        vet_caption: "Learning commands. Sometimes I even follow them",
        park_alt: "Me in the park with another dog and two people",
        park_caption: "In the park with friends",
        car_walk_alt: "Me with Lena by the car, already pulling the leash toward business",
        car_walk_caption: "Cars don't scare me. I have places to be",
